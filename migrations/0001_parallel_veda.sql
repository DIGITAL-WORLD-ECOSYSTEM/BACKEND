...
--> statement-breakpoint
INSERT INTO `__new_auth_challenges`("id", "transaction_id", "user_id", "challenge_hash", "challenge_type", "context", "used_at", "created_at", "expires_at") SELECT "id", NULL AS "transaction_id", "user_id", "challenge_hash", "challenge_type", 'login' AS "context", "used_at", "created_at", "expires_at" FROM `auth_challenges`;--> statement-breakpoint
