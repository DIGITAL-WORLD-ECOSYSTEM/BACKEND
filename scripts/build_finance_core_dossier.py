...
inconsistencies = [
    ...
    "- Defasagem Documental de Contagem de Arquivos: A documentação estática legada docs/FINANCE_CORE_COMPLETE_TREE.md registrava um escopo de 44 arquivos, enquanto a árvore física real e canônica do subsistema compreende 79 arquivos (69 principais + 10 dependências diretas, incluindo testes de arquitetura, integridade de migrations, scripts de seed e governança)."
]
